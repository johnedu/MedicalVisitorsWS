namespace RemoteNotification
{
    ...
    public class Common
    {
        ...
        public static ConfigurationModel GetConfiguration()
        {
            ...
            var remoteNotificationInfo = root.SelectSingleNode("remoteNotificationConfig");
            if (remoteNotificationInfo != null)
            {
                //set current node point to scheduleInterval
                var node = remoteNotificationInfo.SelectSingleNode("scheduleInterval");

                var scheduler = remoteNotificationInfo.SelectSingleNode("scheduleInterval");
                if (scheduler != null)
                {
